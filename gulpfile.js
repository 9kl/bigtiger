...
gulp.task('wheel', shell.task(['python setup.py bdist_wheel'], {'cwd': '/Users/fhp/gitee/bigtiger/bigtiger/src/dist'}));
gulp.task('install', shell.task(['sudo pip install bigtiger-0.2.0-py2-none-any.whl'], {'cwd': '/Users/fhp/gitee/bigtiger/bigtiger/src/dist/dist'}));
